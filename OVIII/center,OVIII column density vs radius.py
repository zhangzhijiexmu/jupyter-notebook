"""
    1、运行本程序即可得到图片'center,OVIII column density vs radius.pdf'， 这里观测者位于星系中心位置。
    """
...
degree_theta=0 #这里观测者为于星系中心，郑勇文章中的坐标系定义就失去了意义，所以用左边位置来定义,即degree_theta= 0   #degree_theta 为观测者在盘上的位置，从星系中心指向 -x1 逆时针算起角度
...
plt.savefig("center,OVIII column density vs radius.pdf",format='pdf', dpi=1000)
